...
def stego_path_generator(cover_img_path: str, img_type: str):
    ...
    steg_directory= cover_img_path[:len(cover_img_path)-len(full_name)]
    name = full_name.split(".")[0]
    steg_name = name + "_Top Secret." + img_type
    print("Dies ist ein Text",steg_directory+steg_name)
    return steg_directory+steg_name
    '''

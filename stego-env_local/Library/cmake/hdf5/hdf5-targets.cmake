...
set_target_properties(hdf5::hdf5-static PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "\$<\$<C_COMPILER_ID:MSVC>:>;\$<\$<CXX_COMPILER_ID:MSVC>:>;C:/Users/maxik/Documents/Semester_6/Projektarbeit/github_repo/Steganography/stego-env_local/Library/lib/z.lib;\$<LINK_ONLY:\$<\$<BOOL:OFF>:>>;\$<\$<NOT:\$<PLATFORM_ID:Windows>>:>"
)
...
set_target_properties(hdf5::hdf5_tools-static PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "\$<\$<C_COMPILER_ID:MSVC>:>;\$<\$<CXX_COMPILER_ID:MSVC>:>;hdf5::hdf5-static;\$<LINK_ONLY:\$<\$<BOOL:OFF>:>>"
)
